...
export const AdminStaff = () => {
  ...
  const openServicesDialog = (employeeId: string) => {
    ...
    const currentServices = employeeServices
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  disabled={!!editingProfile} // Don't allow email changes
                />
              </div>
              ...
              <div>
                ...
                <Select
                  value={formData.role}
                  onValueChange={(value: "client" | "employee" | "admin") => 
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => openServicesDialog(profile.id)}
                    >
                  ...
                  <div className="flex flex-wrap gap-1">
                    {getEmployeeServices(profile.id).length > 0 ? (
                      getEmployeeServices(profile.id).map((serviceName, index) => (
