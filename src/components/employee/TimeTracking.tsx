...
import { Calendar as CalendarIcon, Clock, Plus, Pencil, Trash2, Eye, EyeOff } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              <h4 className="font-medium text-sm">Estado del día</h4>
              <p className="text-lg font-medium">
                {isToday(selectedDate) ? (
                  selectedDateAppointments.length > 0 ? 'Ocupado' : 'Libre'
                ) : (
                  selectedDateAppointments.length > 0 ? 'Programado' : 'Libre'
                )}
              </p>
            </div>
          </CardContent>
