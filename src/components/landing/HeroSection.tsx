    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="space-y-6 sm:space-y-8">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-serif font-bold leading-tight">
            Tu belleza, nuestra
          ...
          <div className="space-y-4">
            <Button 
              size="lg" 
              className="text-lg px-12 py-6 h-auto bg-primary hover:bg-primary/90 shadow-elegant transition-all duration-300 hover:scale-105" 
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <Button 
                variant="outline" 
                size="lg" 
                className="text-base px-8 py-4 h-auto bg-white/10 border-white/30 text-white hover:bg-white/20 backdrop-blur-sm" 
