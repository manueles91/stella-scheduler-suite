-- Task 1: Populate categories and services based on salon menu image
...
-- Get category IDs for service insertion
...
ADD COLUMN business_name TEXT DEFAULT 'Salón de Belleza',
ADD COLUMN business_address TEXT DEFAULT 'Dirección del Salón',
ADD COLUMN business_phone TEXT DEFAULT '+506 1234-5678',
ADD COLUMN business_email TEXT DEFAULT 'info@salon.com',
ADD COLUMN business_hours JSONB DEFAULT '{"monday": "9:00 AM - 6:00 PM", "tuesday": "9:00 AM - 6:00 PM", "wednesday": "9:00 AM - 6:00 PM", "thursday": "9:00 AM - 6:00 PM", "friday": "9:00 AM - 6:00 PM", "saturday": "9:00 AM - 4:00 PM", "sunday": "Cerrado"}',
ADD COLUMN google_maps_link TEXT DEFAULT 'https://maps.google.com',
ADD COLUMN testimonials JSONB DEFAULT '[
  {
    "id": 1,
    "name": "María González",
    "text": "Excelente servicio, muy profesionales y el ambiente es muy relajante. Recomiendo totalmente este salón.",
    "rating": 5,
  ...
  },
  {
    "id": 2,
    "name": "Ana López", 
    "text": "Las manicuras son perfectas y duran mucho tiempo. El personal es muy amable y atento.",
    "rating": 5,
  ...
  },
  {
    ...
    "text": "Me encantan los masajes relajantes. Siempre salgo renovada y con mucha energía.",
    "rating": 5,
    "service": "Masaje Relajante"
  }
]',
ADD COLUMN hero_title TEXT DEFAULT 'Bienvenida a tu Salón de Belleza',
ADD COLUMN hero_subtitle TEXT DEFAULT 'Descubre la experiencia de belleza más completa con nuestros tratamientos profesionales';
